...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->comboBox1->Text = L"Метод половинного деления";
			// 
			// label1
			// 
			...
			this->label2->Text = L"Интервал до:";
			// 
			// label3
			// 
			...
			this->label3->Text = L"Интервал от:";
			// 
			// label4
			// 
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (comboBox1->SelectedItem == "Метод половинного деления")
		{
			x = findroot(testf2, a, b, eps);
		
		}
		if (comboBox1->SelectedItem == "Метод итераций")
		{
			x = FindRoot(testf2, eps,10);

		}
		if (comboBox1->SelectedItem == "Метод Ньютона")
		{
